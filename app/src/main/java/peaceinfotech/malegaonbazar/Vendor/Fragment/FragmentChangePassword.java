...
public class FragmentChangePassword extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_vendor_change_password,container,false);

        etOldPass=view.findViewById(R.id.et_old_pass);
        etNewPass=view.findViewById(R.id.et_new_pass);
        etNewRePass=view.findViewById(R.id.et_new_re_pass);
        btChangePass=view.findViewById(R.id.bt_change_pass);
    ...
    public void changePassword(final String newPass){
        ApiUtils.getServiceClass().changePassword(SaveSharedPreference.getMobileAndPassword(getActivity()).get(0),
                SaveSharedPreference.getMobileAndPassword(getActivity()).get(1),
